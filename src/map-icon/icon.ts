...
export class DynamicMapIcon {
    ...
    public static destroyAll(): void {
        amx.callNative("DestroyAllDynamicMapIcons", "");
    }

    public static get count(): number {
        return amx.callNative("CountDynamicMapIcons", "").retval;
    }
    ...
    public get item(): StreamerItem {
        return StreamerItem.get(StreamerTypes.MAP_ICON, this.id);
    }

    public is(icon: DynamicMapIcon): boolean {
